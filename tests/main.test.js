...
const repoToClone = "https://github.com/arslanarshad31/MessagingApp.git";
const folderPaths = ["gradle/wrapper", "app/src/main"]; // to be modified with the repo
