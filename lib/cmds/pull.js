...
const { getClientRepository, getClientCreds } = require('../graphlql/query')
...
async function updateFolderFromMain(currentDir, username, password) {
  try {
    ...
    // )
    const mainRepoPath =
      '/var/folders/qd/9c9qtggs0tgg71xhfmngywth0000gn/T/git-slice/2083324359'
