...
const { getClientCommitMessage, getClientCreds } = require('../graphlql/query')
const {
  getAllFiles,
  getCurBranch,
...
async function updateMainFromFolder(
  ...
  try {
    ...
    console.log(creds, 'push credentials', commitMsg, 'commitmessage')
