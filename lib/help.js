    ...
    const sections = [
      ...
      },
      {
        ...
        content: [
          ...
          "",
          "Create a new folder in the current directory, initiates it into a new git repository and copies the specified folders from the primary repo into it."
        ]
      },
      {
        ...
        content: [
          "[bold]{git-slice pull}",
          "",
          "Sync updated from the primary repo into the sliced repo."
        ]
      },
      {
        ...
        content: [
          ...
          "",
          "Create a new branch in the primary repo, sync changes made in the sliced repo into that branch and commit those changes with commit message"
        ]
      }
    ];
