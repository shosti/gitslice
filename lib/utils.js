...
async function mergeFromOrigin(repo, branchName, username, password) {
  try {
    ...
    const headCommit = (await repo.getHeadCommit()).message()
    console.log(`Head commit: ` + JSON.stringify({ headCommit }))
